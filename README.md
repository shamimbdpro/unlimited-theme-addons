...
1. Upload the entire "unlimited-theme-addons" directory to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Go to "Theme Addons" menu and configure your settings
1. On the other way you can Activate the plugin through the ‘Plugins Menu’ screen in WordPress
...
1. Plugin Dasbhoard.
1. Elementor Template Shortcode.
1. Template Kit Shortcode.
1. Testimonial.
