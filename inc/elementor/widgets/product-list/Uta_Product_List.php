...
class Uta_Product_List extends Widget_Base
{
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .uta-product-list.uta-product-overlay .woocommerce ul.products li.product .overlay .product-link' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .uta-product-list.uta-product-overlay .woocommerce ul.products li.product .overlay .added_to_cart' => 'color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        } else if ('best-selling-products' == $settings['uta_product_list_product_filter']) {
            $args['meta_key'] = 'total_sales';
            $args['orderby'] = 'meta_value_num';
            $args['order'] = 'DESC';
        } else if ('sale-products' == $settings['uta_product_list_product_filter']) {
            $args['meta_query'] = [
                'relation' => 'OR',
                [
                    'key' => '_sale_price',
        ...
        } else if ('top-products' == $settings['uta_product_list_product_filter']) {
