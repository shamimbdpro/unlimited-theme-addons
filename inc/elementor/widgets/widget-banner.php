...
class cpthelper_Widget_Banner extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Banner', 'unlimited-theme-addons' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'banner_section',
         [
			 'label' => esc_html__( 'Banner', 'unlimited-theme-addons' ),
      ...
      $this->add_control(
         'search',
         [
			 'label' => __( 'Search', 'unlimited-theme-addons' ),
      ...
      $this->add_control(
         'searchtext',
         [
			 'label' => __( 'Search Text', 'unlimited-theme-addons' ),
			 'type' => \Elementor\Controls_Manager::TEXT,
			 'default' => __('Search Product','unlimited-theme-addons' ),
			 'condition' => [ 'search' => 'on' ],
         ]
      );
      ...
      $this->add_control(
         'products',
         [
			 'label' => __( 'Products', 'unlimited-theme-addons' ),
			 'type' => \Elementor\Controls_Manager::SWITCHER,
			 'label_on' => __( 'On', 'unlimited-theme-addons' ),
			 'label_off' => __( 'Off', 'unlimited-theme-addons' ),
			 'return_value' => 'on',
      ...
      $this->add_control(
         'counter',
         [
			 'label' => __( 'Counter', 'unlimited-theme-addons' ),
			 'type' => \Elementor\Controls_Manager::SWITCHER,
			 'label_on' => __( 'On', 'unlimited-theme-addons' ),
			 'label_off' => __( 'Off', 'unlimited-theme-addons' ),
			 'return_value' => 'on',
      ...
      $this->add_control(
         'experience',
         [
			 'label' => __( 'Years of experience', 'unlimited-theme-addons' ),
			 'type' => \Elementor\Controls_Manager::TEXT,
			 'default' => 2014,
      ...
      $button->add_control(
         ...
         [
			 ...
			 'type' => \Elementor\Controls_Manager::TEXT,
			 'default' => __( 'Learn More', 'unlimited-theme-addons' ),
         ]
      );
      ...
      $this->add_control(
         'button_list',
         [
			 'label' => __( 'Button List', 'unlimited-theme-addons' ),
			 'type' => \Elementor\Controls_Manager::REPEATER,
			 'fields' => $button->get_controls(),
			 'default' => [
				 [
					 'button' => __( 'Shop Now', 'unlimited-theme-addons' ),
					 'button_url' => '#',
				 ],
				 [
					 'button' => __( 'Learn More', 'unlimited-theme-addons' ),
					 'button_url' => '#',
				 ],
			 ],
			 'title_field' => '{{{ button }}}',
      ...
      $this->add_control(
        'text_color',
        [
			'label' => __( 'Text Color', 'unlimited-theme-addons' ),
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="banner-content">
                  ...
                  <p <?php echo esc_html( $this->get_render_attribute_string( 'description' ) ); ?>><?php echo esc_html( $settings['description'] ); ?></p>  
            ...
            <div class="row banner-counter">
              <div class="col-sm-3">
                <div class="counter-item">
                  ...
                  <h5><?php echo esc_html__( 'Customers' , 'unlimited-theme-addons' ) ?></h5>
                </div>
              </div>
              ...
              <div class="col-sm-3">
                <div class="counter-item">
                  ...
                  <h5><?php echo esc_html__( 'Items' , 'unlimited-theme-addons' ) ?></h5>
                </div>
              </div>
              ...
              <div class="col-sm-3">
                <div class="counter-item">
                  ...
                  <h5><?php echo esc_html__( 'Sales' , 'unlimited-theme-addons' ) ?></h5>
                </div>
              </div>
              ...
              <div class="col-sm-3">
                <div class="counter-item">
                  ...
                  <h5><?php echo esc_html__( 'Years of experience' , 'unlimited-theme-addons' ) ?></h5>
                </div>
              </div>
            </div>
            <?php } ?>
