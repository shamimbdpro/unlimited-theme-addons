...
<ul>
    ...
    foreach ( $settings['feature_list'] as $index => $feature ) {
        ...
        <div class="pricing-btn">
			<a class="pricing" href="<?php echo esc_url($settings['btn_url']) ?>" <?php echo $this->get_render_attribute_string('btn_text'); ?>><?php echo esc_html($settings['btn_text']); //phpcs:ignore ?></a>
		</div>
    </div>